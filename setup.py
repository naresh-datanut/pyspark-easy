...
setup(
  ...
  keywords = ['pyspark', 'dataframe', 'evaluation','model','classification','multiclass classification','binary classification','results','summary','explore','EDA'],   # Keywords that define your package best
